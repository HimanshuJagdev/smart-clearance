...
const navItems: { key: PageKey; label: string; icon: typeof LayoutDashboard }[] = [
  ...
  { key: 'approvals', label: 'My Approvals', icon: FileCheck2 },
  { key: 'navigator', label: 'Approval Navigator', icon: Compass },
  { key: 'documents', label: 'Documents', icon: FolderOpen },
  { key: 'compliance', label: 'Compliance', icon: ShieldCheck },
  { key: 'ai-insights', label: 'AI Insights', icon: Sparkles },
  { key: 'services', label: 'Government Services', icon: Landmark },
